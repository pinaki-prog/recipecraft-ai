...
export const NUTRITION_DB = {
  ...
  // Specific fish — much higher omega-3 accuracy
  salmon:     { cal:208,  p:20,   c:0,    f:13,   fibre:0,
                gi:0,   gl:0,   pdcaas:0.97,
                omega3:2.26, omega6:0.57,   // Atlantic salmon: 2.26g EPA+DHA+ALA per 100g
                sodium:59,   potassium:363, magnesium:27,  zinc:0.6,
                iron:0.3,    calcium:9,     vitC:3,   vitA:50,
                vitB12:3.2,  vitD:526,      folate:25,
                typicalUseQty:150,
                satiety:240, inflam:-5,
                dietaryGroup:"non-veg",
                tags:["omega-3-rich","anti-inflammatory","vitD-source","B12-source","heart-health","high-protein","fatty-fish"] },

  tuna:       { cal:144,  p:30,   c:0,    f:1,    fibre:0,
                gi:0,   gl:0,   pdcaas:0.96,
                omega3:0.37, omega6:0.01,
                sodium:50,   potassium:397, magnesium:35,  zinc:0.6,
                iron:1.0,    calcium:10,    vitC:0,   vitA:22,
                vitB12:2.5,  vitD:269,      folate:2,
                typicalUseQty:150,
                satiety:230, inflam:-3,
                dietaryGroup:"non-veg",
                tags:["high-protein","lean","B12-source","omega-3-rich","low-fat"] },

  mackerel:   { cal:205,  p:19,   c:0,    f:14,   fibre:0,
                gi:0,   gl:0,   pdcaas:0.96,
                omega3:2.67, omega6:0.22,   // Indian mackerel (bangda): ~2.67g omega3
                sodium:90,   potassium:314, magnesium:60,  zinc:0.6,
                iron:1.3,    calcium:12,    vitC:0,   vitA:50,
                vitB12:8.7,  vitD:360,      folate:1,
                typicalUseQty:150,
                satiety:235, inflam:-5,
                dietaryGroup:"non-veg",
                tags:["omega-3-rich","anti-inflammatory","B12-source","vitD-source","heart-health","high-protein"] },

  sardine:    { cal:208,  p:25,   c:0,    f:11,   fibre:0,
                gi:0,   gl:0,   pdcaas:0.96,
                omega3:1.48, omega6:0.10,
                sodium:307,  potassium:397, magnesium:39,  zinc:1.3,
                iron:2.9,    calcium:382,   vitC:0,   vitA:54,
                vitB12:8.9,  vitD:193,      folate:10,
                typicalUseQty:100,
                satiety:220, inflam:-4,
                dietaryGroup:"non-veg",
                tags:["omega-3-rich","calcium-rich","B12-source","iron-rich","anti-inflammatory"] },

  pomfret:    { cal:95,   p:16,   c:0,    f:2.5,  fibre:0,
                gi:0,   gl:0,   pdcaas:0.95,
                omega3:0.60, omega6:0.12,
                sodium:80,   potassium:350, magnesium:28,  zinc:0.5,
                iron:0.7,    calcium:22,    vitC:0,   vitA:40,
                vitB12:1.8,  vitD:200,      folate:10,
                typicalUseQty:150,
                satiety:200, inflam:-3,
                dietaryGroup:"non-veg",
                tags:["lean","high-protein","omega-3-rich","B12-source","low-calorie"] },

  rohu:       { cal:97,   p:17,   c:0,    f:2.2,  fibre:0,
                gi:0,   gl:0,   pdcaas:0.94,
                omega3:0.30, omega6:0.25,
                sodium:65,   potassium:280, magnesium:22,  zinc:0.4,
                iron:0.8,    calcium:30,    vitC:0,   vitA:30,
                vitB12:1.5,  vitD:160,      folate:12,
                typicalUseQty:150,
                satiety:195, inflam:-2,
                dietaryGroup:"non-veg",
                tags:["lean","high-protein","B12-source","low-calorie"] },

  catla:      { cal:101,  p:17,   c:0,    f:2.8,  fibre:0,
                gi:0,   gl:0,   pdcaas:0.94,
                omega3:0.35, omega6:0.20,
                sodium:68,   potassium:290, magnesium:24,  zinc:0.5,
                iron:0.9,    calcium:28,    vitC:0,   vitA:35,
                vitB12:1.6,  vitD:170,      folate:10,
                typicalUseQty:150,
                satiety:198, inflam:-2,
                dietaryGroup:"non-veg",
                tags:["lean","high-protein","B12-source"] },
...
// nutritionOverrides: { [itemName]: { cal, p, c, f, ... } }
// Used to inject USDA real data for ingredients not in our DB
export function computeNutritionTotals(ingredients, nutritionOverrides = {}) {
  const totals = {
  ...
  ingredients.forEach(item => {
    // USDA override takes priority over our DB for unknown ingredients
